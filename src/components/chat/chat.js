...
import { IsUserContext } from '../contextApi/IsUserContext';
...
// liên tục cập nhật giá trị messages khi có sự thay đổi trong cuộc trò chuyện
  useEffect(() => {
...
// lọc các tin nhắn trong mảng messages dựa trên giá trị searchQuery và cập nhật kết quả lọc vào biến searchResults.
  useEffect(() => {
